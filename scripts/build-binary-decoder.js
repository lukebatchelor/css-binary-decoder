...
function buildDecoderHtml(maxDepth) {
  ...
  const htmlTemplate = `
    ...
    <footer class="footer">Check out <a href="https://github.com/lukebatchelor/css-tic-tac-toe">lukebatchelor/css-tic-tac-toe</a> if you're interested in how it works!</p>
