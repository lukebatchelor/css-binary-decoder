...
function buildDecoderHtml(maxDepth) {
  ...
  const htmlTemplate = `
    ...
    <footer class="footer">Check out <a href="https://github.com/lukebatchelor/css-binary-decoder">lukebatchelor/css-binary-decoder</a> if you're interested in how it works!</p>
    <a href="https://github.com/lukebatchelor/css-binary-decoder"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_darkblue_121621.png" alt="Fork me on GitHub"></footer>
    </body>
    </html>
  `;
